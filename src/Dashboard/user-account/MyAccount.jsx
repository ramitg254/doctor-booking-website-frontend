                    ...
                    !loading && !error && <div className="grid md:grid-cols-3 gap-10">
                        <div className="pb-[50px] px-[30px] rounded-md">
                            <div className="flex items-center justify-center">
                                <figure className='w-[100px] h-[100px] rounded-full border-full border-2 border-solid border-primaryColor'>
                            ...
                            <div className="mt-[50px] md:mt-[65px]">
                                <button
                        ...
                        <div className="md:col-span-2 md:px-[30px]">
                            <div>
                                ...
                                <button
                                    onClick={() => setTab('settings')} className={`${tab === 'settings' && "bg-primaryColor text-white font-normal"} py-2 px-5 rounded-md text-headingColor font-semibold text-[16px] leading-7 border border-solid border-primaryColor`}>
                                    Profile Settings
                                </button>
                            </div>
                            {
