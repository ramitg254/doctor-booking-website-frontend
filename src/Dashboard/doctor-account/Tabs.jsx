...
const Tabs = ({ tab, setTab }) => {
  ...
  return (
    <div>
      ...
      <div ref={menuRef} onClick={toggleMenu} className="hidden lg:flex flex-col p-[30px] bg-white shadow-panelShadow items-center h-max rounded-md">
        <button
        ...
        <div className="mt-[65px] w-full">
          <button
            ...
            className=' w-full bg-[#181A1E] p-3 pt-2 text-[16px] leading-7 rounded-md text-white'>
            Logout
          </button>
