...
const Profile = ({ doctorData }) => {
    ...
    useEffect(() => {
        setFormData({
            ...
            phone: !(doctorData?.phone)?"":doctorData?.phone,
            bio: !(doctorData?.bio)?"":doctorData?.bio,
            gender: !(doctorData?.gender)?"":doctorData?.gender,
            specialization: !(doctorData?.specialization)?"":doctorData?.specialization,
            ticketPrice: !(doctorData?.ticketPrice)?0:doctorData?.ticketPrice,
            qualifications: !(doctorData?.qualifications)?[]:doctorData?.qualifications,
            experiences: !(doctorData?.experiences)?[]:doctorData?.experiences,
            timeSlots: !(doctorData?.timeSlots)?[]:doctorData?.timeSlots,
            about: !(doctorData?.about)?"":doctorData?.about,
            ...
            <form >
                ...
                <div className='mb-5'>
                    ...
                    <input type="email"
                        ...
                        onChange={handleInputChange} placeholder='Email' className='form__input'
                        readOnly
                        aria-readonly
                        disabled={true} />
                </div>
                ...
                <div className='mb-5'>
                    ...
                    <input type="text"
                        ...
                        onChange={handleInputChange} placeholder='Bio' className='form__input'
                        maxLength={100}
                    />
                </div>
                <div className="mb-5">
                ...
                <div className="mt-7">
                    <button type='submit'
                        onClick={updateProfileHandler} className='bg-primaryColor text-white text-[18px] leading-[30px] w-full py-3 px-4 rounded-lg'>Update Profile</button>
                </div>
            </form>
        </div>
    )
