                    ...
                    placeholder:text-textColor rounded-md cursor-pointer'
                        ...
                        <div className="mb-5 flex items-center justify-between">
                            ...
                            >
                                ...
                                <select name="role"
                                    value={formData.role}
                                    onChange={handleInputChange} className="text-textColor bg-white font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none">
                            ...
                            >
                                ...
                                <select name="gender"
                                    ...
                                    onChange={handleInputChange}
                                    className="text-textColor bg-white font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none">
